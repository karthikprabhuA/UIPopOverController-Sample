...
@interface AKPTableViewController ()

@end

@implementation AKPTableViewController
@synthesize delegate;
@synthesize arrList;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
     ...
     */
    [self.delegate DomainListSelected:[self.arrList objectAtIndex:indexPath.row ]];
}
